...
namespace sc2 {
    ...
    enum class UNIT_TYPEID {
        ...
        TERRAN_PREVIEW_BUNKER_UPGRADED = 1967,    
    ...
    enum class ABILITY_ID {
        ...
        RESEARCH_BALLISTICRANGE = 1533,     //Target: None
        ...
        RESEARCH_LURKERRANGE = 3710,    // Target: None.     
        ...
        RESEARCH_RAPIDREIGNITIONSYSTEM = 1534,     // Target: None.
