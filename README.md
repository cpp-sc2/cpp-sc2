...
* A [build guide](docs/building.md) and [tutorials](docs/tutorial1.md) are
  available to help to get started.
...
Follow the [build guide](docs/building.md) to help through the process.

## Additional Maps

This repository only comes with a few maps for testing.
Additional maps can be found on the [AI Arena](https://aiarena.net/wiki/maps/)
website.
