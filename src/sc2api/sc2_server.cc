...
static int WebSocketDataHandler(struct mg_connection* conn, int /*flags*/, char* data, size_t len,
...
bool Server::Listen(const char* listeningPorts, const char* requestTimeoutMs, const char* websocketTimeoutMs,
    ...
    mg_set_websocket_handler(mg_context_, "/sc2api", WebSocketConnectHandler, nullptr, WebSocketDataHandler,
                             WebSocketCloseHandler, (void*)this);
