...
namespace sc2 {
    ...
    const char* UnitTypeToName(UnitTypeID unit_type) {
        ...
        case UNIT_TYPEID::MINERALFIELD450:                             return "MINERALFIELD450";
    ...
    const char* AbilityTypeToName(AbilityID ability_type) {
        ...
        case ABILITY_ID::HOLDPOSITION_GENERAL:              return "HOLDPOSITION"; // 3793
        ...
        case ABILITY_ID::RESEARCH_LIBERATORAGRANGEUPGRADE:  return "RESEARCH_LIBERATORAGRANGEUPGRADE"; // 140
        case ABILITY_ID::RESEARCH_MEDIVACINCREASESPEEDBOOST:  return "RESEARCH_MEDIVACINCREASESPEEDBOOST"; // 139
