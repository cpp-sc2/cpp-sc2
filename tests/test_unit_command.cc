...
public:
    ...
    void AdditionalTestSetup() override {
        ...
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::PROTOSS_PYLON, origin_pt_, agent_->Observation()->GetPlayerID(),
                                         1);
        agent_->Debug()->SendDebug();
    }
...
public:
    ...
    void AdditionalTestSetup() override {
        ...
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::ZERG_CREEPTUMORBURROWED, GetPointOffsetX(origin_pt_, -10),
...
public:
    ...
    void AdditionalTestSetup() override {
        agent_->Debug()->DebugCreateUnit(target_unit_type_, GetPointOffsetX(origin_pt_, 10),
                                         agent_->Observation()->GetPlayerID(), 1);
        agent_->Debug()->SendDebug();
    }
...
public:
    ...
    void OnStep() override {
        ...
        if (!hatchery_spawned_) {
            agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::ZERG_HATCHERY, target_point_,
...
public:
    ...
    void AdditionalTestSetup() override {
        ...
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::PROTOSS_NEXUS, GetPointOffsetX(origin_pt_, -20),
                                         agent_->Observation()->GetPlayerID(), 1);
        agent_->Debug()->SendDebug();
    }
...
public:
    ...
    void AdditionalTestSetup() override {
        ...
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::PROTOSS_PYLON, origin_pt_, agent_->Observation()->GetPlayerID(),
                                         1);
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::PROTOSS_PYLON, GetPointOffsetX(origin_pt_),
                                         agent_->Observation()->GetPlayerID(), 1);
        agent_->Debug()->SendDebug();
    }
...
public:
    ...
    void AdditionalTestSetup() override {
        agent_->Debug()->DebugCreateUnit(UNIT_TYPEID::TERRAN_MARAUDER, origin_pt_, agent_->Observation()->GetPlayerID(),
                                         3);
        agent_->Debug()->SendDebug();
    }
